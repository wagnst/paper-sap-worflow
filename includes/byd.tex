...
Wir haben jetzt alles vorbereitet um eine Ausschreibung zu erstellen. Dies geschieht im WorkCenter "Ausschreibungen und Kontrakte". Dort gehen wir auf "Ausschreibungen und Angebote". Wir klicken wieder auf "Neu" und füllen die allgemeinen Daten für unsere Ausschreibung (\ref{sendrfq}). 
...
Wenn die Bieter nun Angebote einschicken können wir diese über eine Eingabemaske in \gls{byd} einfügen (\ref{sendrfq}). Dabei werden allgemeine Daten und Preise des Anbieters eingegeben (\ref{sendrfq}). Weiterhin können wir dann die Angebot anzeigen und vergleichen und dann dem Besten den Zuschlag geben.
