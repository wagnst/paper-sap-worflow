...
\begin{table}[H]
	\begin{tabular}{|c|p{2.2cm}|p{11cm}|}
		...
		\hline 
		\includegraphicstotab[width=1cm]{grafiken/dokument-aus-vorlage.png}
		& 
		...
		\hline 
		\includegraphicstotab[width=1cm]{grafiken/ablaufsteuerung.png}
		& 
		...
		\hline 
		\includegraphicstotab[width=1cm]{grafiken/schleife.png}
		& 
		Schleifen & Mehrfache Ausführung eines Blocks von Schritten unter einer bestimmten Bedingung\\ 
		\hline 
		\includegraphicstotab[width=1cm]{grafiken/paralleler-abschnitt.png}
		& 
		Paralleler Abschnitt & Aufsplitten des Workflows in zwei parallel laufende Pfade\\ 
		\hline 
		\includegraphicstotab[width=1cm]{grafiken/ad-hoc-anker.png}
		& 
		...
		\hline 
		\includegraphicstotab[width=1cm]{grafiken/block.png}
		& 
		Block & Zusammenfassen mehrerer Schritte zu einem Block mit eigenen Variablen\\ 
		\hline 
		\includegraphicstotab[width=1cm]{grafiken/lokaler-workflow.png}
		& 
