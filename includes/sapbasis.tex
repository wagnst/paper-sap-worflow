...
In heutigen \gls{sap} Umgebungen sind Betriebssysteme wie \emph{Microsoft Windows Server}, \emph{Red Hat Enterprise Linux}, \emph{SuSE Linux}, sowie verschiedene \emph{UNIX} Varianten geläufig. Auch Host-Betriebssysteme (\emph{z/OS}, \emph{OS400}) werden als Plattform eines SAP-Systems unterstützt. 
...
\begin{center}
	\begin{verbatim}
		Selektierte Sätze von employees.salaries: 2844047 Dauer: 3.2692410945892 Sekunden 
	\end{verbatim}
\end{center}
