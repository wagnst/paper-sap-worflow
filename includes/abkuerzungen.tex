...
\newglossaryentry{byd}{
		name=ByD,
		description={Business ByDesign (siehe \ref{sec:byd}},
		first={Business ByDesign (ByD)},
		long={Business ByDesign}		
}
...
\newglossaryentry{icm}{
		name=ICM,
		description={Internet Communication Managers},
		first={Internet Communication Managers (ICM)},
		long={Internet Communication Managers}		
}

\newglossaryentry{its}{
		name=ITS,
		description={Internet Transaction Server},
		first={Internet Transaction Server (ITS)},
		long={Internet Transaction Server}		
}

\newglossaryentry{hub}{
		name=HUB,
		description={Hauptumschlagsbasis},
		first={Hauptumschlagsbasis (HUB)},
		long={Hauptumschlagsbasis}		
}
...
\newglossaryentry{customizing}{
name=Customizing,
description={Anpassung eines Systems oder einer Systemlandschaft an die Bedürfnisse und Arbeitsabläufe einer Firma meist ohne größeren Programmieraufwand}
}
